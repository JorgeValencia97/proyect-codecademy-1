...
def get_route(start_point, end_point):
    ...
    for start_station in start_stations:
        for end_station in end_stations:
            metro_system = get_active_stations() if stations_under_consutruction else vc_metro
            if stations_under_consutruction:
...
def get_active_stations():
    ...
    for station_under_construction in stations_under_consutruction:
        for current_station, neighboring_station in vc_metro.items():
            if current_station != station_under_construction:
                updated_metro[current_station] -= set(stations_under_consutruction)
            else:
